...
class DataProcesser:
    ...
    def load_data(self, file_path, file_type="csv"):
        ...
        if file_type == "csv":
            new_data = pd.read_csv(FILE_PATH, names=COLUMN_NAME, sep=SEPRATOR)
        elif file_type == "json":
    ...
    # TODO: Save the output file
        ...
        df_ligands.to_csv(
            "/mnt/sdb/PROJECT_ML/ChEMBl_GDB13s_graph_learning/---TRANSFORMER_UBELIX---/test14-pure_ChEMBL_REDO_no_data_leakage/translation-beam50/pred_test14_all_confidence_score_similarities_qed_sas_structure_changes.xls",
