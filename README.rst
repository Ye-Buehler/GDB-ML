...
Steps 5 and 6 require an NVIDIA GPU with CUDA. If using a GPU, replace pytorch=2.7.0 with pytorch-gpu=2.7.0 in environment-gdb20.yaml before creating the environment.
